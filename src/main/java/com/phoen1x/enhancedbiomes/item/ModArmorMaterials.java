...
public enum ModArmorMaterials implements ArmorMaterial {
    PRISMARINE("prismarine", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ARMOR_EQUIP_CHAIN, 2.0F, 0.0F, () -> {
        return Ingredient.of(ModItems.PEARL.get());
    });
    ...
    public String getName() {
        return EnhancedBiomes.MOD_ID + ":" + this.name;
    }
