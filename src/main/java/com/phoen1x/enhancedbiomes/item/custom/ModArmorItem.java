package com.phoen1x.enhancedbiomes.item.custom;

import com.google.common.collect.ImmutableMap;
import com.phoen1x.enhancedbiomes.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorMaterials.PRISMARINE,
                            new MobEffectInstance(MobEffects.WATER_BREATHING, 999999999, 0)).build();
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP2 =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorMaterials.PRISMARINE,
                            new MobEffectInstance(MobEffects.DOLPHINS_GRACE, 999999999, 0)).build();
    ...
    private boolean hasFullSuitOfArmourOn(Player player) {
